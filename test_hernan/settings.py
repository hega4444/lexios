...
UPLOAD_FOLDER = 'test_hernan/temp_uploads'
DOWNLOAD_FOLDER = 'test_hernan/temp_downloads'
TIME_ZONE = "Europe/Berlin" # values accecpted: from Datetime library
TIME_DELTA = 0 # Adjust time zone if neccesary (min)
LOG_FOLDER = 'test_hernan/backlogs'
...
SERVER_PORT = 8000
ENABLE_SSL = False
SSL_KEYFILE = 'test_hernan/ssl/key.pem'
SSL_CERTFILE = 'test_hernan/ssl/cert.pem'
...
LEXI_DATABASE_NAME = 'test_hernan_database'
