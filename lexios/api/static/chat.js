...
document.addEventListener("DOMContentLoaded", async function () {
    ...
    const fetchConversationData = async () => {
        try {
            ...
            const result = {
                messages: messages,
                conversations_list: conversations_list // Add other_titles to the result object
            };
    ...
    try {
        ...
        // Add here the logic for messages in the main area
        if (result.messages && result.messages.length > 0) {
            ...
            console.log('No messages to display in the main area.');
        }
